...
(defn report
  ...
  (let [best (first pop)]
    (str "Generation: " generation ",  "
         ...
         "Best program: " (push-from-plushy (:plushy best)) ",  "
...
;;     :as argmap}]
;;   (reset! report (str "Starting GP with args:" argmap))
;;   (loop [generation 0
...
;;       (cond
;;         (zero? (:total-error (first evaluated-pop))) (swap! report conj "SUCCESS!")
...
;;    [& args]
;;    (binding [*ns* (the-ns 'propeller-site.propel)]
